...
// //***********************************************/
// //
// /* Methods are similar to functions: Declare with fn, have parameters and 
// a return value. Unlike functions, methods are defined within the context 
// of a struct (or an enum or a trait object), and their first parameter is 
